...
@Controller
@RequestMapping(value = "/cuentaPacie")
public class RecuperCPaci {
    @Autowired
    ...
    public String mostrarFor(Model model){
        ...
        return("RecupeCuePAcie");
    }
    @RequestMapping(value="/recuperar", method= RequestMethod.POST)
    public String forgotUserPassword(Model model, Paciente paciente) {
        Paciente existingPacie = reposiPacien.findByCorreo(paciente.getCorreo());
        if (existingPacie!= null) {
            ...
            mailMessage.setTo(existingPacie.getCorreo());
            mailMessage.setSubject("Complete Password Reset!");
            mailMessage.setFrom("chronic.patient02@gmail.com");
            mailMessage.setText("Tu contrasena es: "+ existingPacie.getContrasena());
